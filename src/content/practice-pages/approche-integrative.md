...
L'approche intégrative n'est pas une école supplémentaire : elle prend appui sur l'histoire des psychothérapies et sur ses quatre grands courants fondateurs.
...
- des techniques de **régulation émotionnelle** et d'apaisement corporel (respiration, ancrage, gestion des états de tension) ;
- l'**identification des cercles vicieux** de pensées et de comportements qui entretiennent l'anxiété, l'évitement ou la dévalorisation ;
...
## Ce qui soigne : l'alliance, le cadre, l'ajustement
...
**L'ajustement**, enfin. Un accompagnement utile suppose que je reste attentif à vos besoins immédiats comme à ceux du long terme, que je tienne compte de ce que vous me dites de vos progrès et de vos blocages, et que je modifie ce qui doit l'être. Cela suppose aussi, de mon côté, une formation continue et un travail régulier sur ma propre pratique : dans cette approche, le premier instrument du thérapeute reste lui-même.

## Trois principes de travail

- **Chercher la synergie.** Les outils ne sont pas juxtaposés : un travail d'apaisement corporel et une réflexion sur votre histoire se renforcent l'un l'autre lorsqu'ils sont articulés au bon moment.
- **Envisager une fonction au problème.** Un symptôme n'est pas seulement une panne à réparer. L'anxiété peut protéger d'un risque, un évitement peut préserver un équilibre, une conduite addictive peut apaiser une douleur ancienne. Comprendre à quoi sert un symptôme change radicalement la manière de s'en dégager.
- **S'adapter à votre fonctionnement.** Votre rythme, votre rapport aux mots, votre tolérance à l'émotion, ce que vous êtes prêt à explorer aujourd'hui : c'est le travail qui s'ajuste à vous, pas l'inverse.

## Ce que l'approche intégrative n'est pas

Il me paraît honnête de nommer les dérives possibles, car le mot « intégratif » est aujourd'hui très employé et rarement défini.

Ce n'est pas un **modèle supérieur aux autres**, ni une méthode qui aurait résolu ce que les autres n'ont pas résolu. C'est d'abord une manière de réinterroger sa pratique.

Ce n'est pas un **empilement de techniques**. Accumuler des outils sans cadre théorique conduit à une pratique mécanique, où l'on applique un protocole sans comprendre ce qui se joue, et où le sens du symptôme et l'histoire de la personne finissent par disparaître. C'est précisément le risque que l'ancrage psychodynamique permet d'éviter.

Ce n'est pas une **promesse de rapidité**. Cette approche demande au contraire d'accepter une certaine complexité, et de renoncer à l'idée qu'un outil bien choisi suffirait à régler une situation humaine.

Enfin, la notion d'efficacité elle-même mérite d'être interrogée. La disparition d'un symptôme et le sentiment de vivre mieux ne se recouvrent pas toujours : certaines personnes n'ont plus de symptôme et ne se sentent pas mieux pour autant. C'est votre appréciation de ce qui a changé, et non la seule mesure des symptômes, qui sert de repère à notre travail.
...
- vous vivez les **suites d'un événement traumatique**, de violences ou de harcèlement ;
- vous êtes confronté à une **problématique addictive** et souhaitez travailler à la fois le comportement et ce qu'il vient apaiser ;
- vous avez déjà entamé une thérapie qui vous a partiellement aidé et cherchez un cadre plus souple ;
- vous ne savez pas encore ce que vous attendez d'une thérapie : les premières séances servent précisément à le clarifier.

Cette approche a aussi ses limites, et il est juste de les nommer. Une psychothérapie n'est pas un traitement d'urgence : en cas de danger immédiat, de risque suicidaire aigu ou de situation médicale instable, un recours aux urgences ou à un médecin est prioritaire. Par ailleurs, un accompagnement psychologique ne remplace pas un suivi médical ou psychiatrique lorsque celui-ci est nécessaire ; le cas échéant, je vous orienterai et travaillerai en articulation avec les professionnels concernés.
...
Sur l'histoire de ce courant, ses modèles et ses enjeux cliniques, l'ouvrage de référence en langue française est celui de Maximilien Bachelart, *L'approche intégrative en psychothérapie. Anti-manuel à l'usage des thérapeutes* (ESF sciences humaines, 1<sup>re</sup> édition 2017, 2<sup>e</sup> édition 2026).

## Prendre rendez-vous

Vous pouvez consulter les [tarifs et conditions](/tarifs/), en savoir plus sur [mon parcours](/a-propos/) ou me [contacter directement](/contact/) si vous hésitez encore sur l'approche qui vous conviendrait. Un premier échange permet souvent d'y voir plus clair.
